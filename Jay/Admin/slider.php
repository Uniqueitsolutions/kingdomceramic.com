    ...
    ADD Slider
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-bordered  table-hover table-rounded table-row-bordered border gy-7 gs-7">
                                                ...
                                                <tbody>
                                                   <?php  
                                                   $result=$sliderObj->selectAllDataForAdmin();
                                                   $sno=1;
                                                   ...
                                                   ?>
                                                    ...
                                                    <td><img src="../../Images/slider/<?php echo $row['ImagePath'] ?>"
                                            alt="<?php echo $row['ImageDescription'] ?>" srcset=""
                                            style="height:150px ;width: 250px;"></td>           
                                ...
                                <td>
                                    <?php if ($row['IsActive'] == 1) {
                                        ...
                                        echo "<span class='badge badge-light-danger'>Disabled</span>";
                                                    ...
                                                    <td>
<div class="row">
<form method="post" class="col-md-6 px-0" action="SliderAddEdit">
<?php $newid = $crypt->encryptId($row['SliderID']); ?>
<input type="hidden" name="SliderID" class="form-control mb-2"
                                                value="<?php echo  $newid  ?>">
                                                       ...
                                                       <svg
                                                        ...
                                                        <form method="post" class="col-md-6 px-0" action="slider.php">
                                                        <input type="hidden" name="SliderID" class="form-control mb-2"
                                                value="<?php echo  $newid  ?>">
