    ...
    <div class="card card-flush border-gray-300 shadow-sm ">
        <div class="card-header">
            ...
            <!-- <div class="card-toolbar">
                    ...
                    <div class="col-md-5">
                    <a type="button" class="btn btn-sm btn-primary" href="ProductAddEdit">
                        ADD PRODUCT
                    </a>
                    </div>
                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table id="myTable" class="table table-bordered table-hover table-rounded table-row-bordered border gy-4 gs-3">
            ...
            <th>Action</th>
                                                ...
                                                <tbody>
                                                   <?php  
                                                   $result=$productObj->selectAllDataForAdmin();
                                                   $sno=1;
            ...
            <td ><img src="../../Images/product/<?php echo $row['ImagePath'] ?>" alt="<?php echo $row['ImageDescription'] ?>" srcset="" style="height:150px ;width: 20s0px;"></td>
            <td ><?php if($row['ForCompany']==1) 
            {echo "Kingdom Ceramic";}else if($row['ForCompany']==2){
                echo "Decasa Ceramic";
            }
            else{
                echo "Both";
            ...
            <td>
                <table>
               <?php if($row['TypeName']!=null){?> 
            <b>Type:</b><tr>&nbsp;<?php echo $row['TypeName'] ?></tr>
            <br/>
            <?php }?>
          
            <?php if($row['FinishName']!=null){?> 
            <b>Finish:</b><tr>&nbsp;<?php echo $row['FinishName'] ?></tr>
            <br/>
            <?php }?>
           
            <?php if($row['LookName']!=null){?> 
            <b>Look:</b><tr>&nbsp;<?php echo $row['LookName'] ?></tr>
            <br/>

            <?php }?>
            <?php if($row['SpaceName']!=null){?> 
            <b>Space:</b><tr>&nbsp;<?php echo $row['SpaceName'] ?></tr>
            <br/>

            <?php }?>
            <?php if($row['SizeName']!=null){?> 
            <b>Size:</b><tr>&nbsp;<?php echo $row['SizeName'] ?></tr>
            <?php }?>
            ...
            <td ><?php echo $row['Modified'] ?></td>
                                                    <td>
                                                    <div class="row">
                                        <form method="post" class="col-md-6 p-0" action="ProductAddEdit">
                                        <?php  $newid= $crypt->encryptId($row['ProductID']); ?>

                                        <input type="hidden" name="ProductID"
                                                value="<?php echo $newid ?>">
                                            <button type="submit" name="edit" class="svg-icon svg-icon-success svg-icon-2hx"
                                            ...
                                            <form method="post" class="col-md-6 p-0" action="Product">
                                                <input type="hidden" name="ProductID"
                                                    value="<?php echo $newid ?>">
