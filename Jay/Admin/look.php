...
if ($result) {
    ...
    <script>
        Swal.fire({
            icon: 'success',
            title: 'Deleted!',
            text: 'The look has been deleted.',
        }).then(function() {
    ...
    <script>
        Swal.fire({
            icon: 'error',
            title: 'Error!',
            text: 'An error occurred while deleting the look.',
        });
    </script>";
}
...
?>
	...
	<div id="kt_content_container" class="container-xxl">
                    ...
                    <div class="col-md-5">
                    <a type="button" class="btn btn-sm btn-primary" href="LookAddEdit">
                        ADD LOOK
                    </a>
                    </div>
                </div>
                            ...
                            <th>Action</th>
                                ...
                                <td>
                                    <div class="row">
                                        <form method="post" class="col-md-6 p-0" action="LookAddEdit">
<?php  $newid= $crypt->encryptId($row['LookID']); ?>

                                            <input type="hidden" name="LookID"
                                        ...
                                        <form method="post" class="col-md-6 p-0" action="Look">
                                            <input type="hidden" name="LookID" 
                                                value="<?php echo $newid ?>">
