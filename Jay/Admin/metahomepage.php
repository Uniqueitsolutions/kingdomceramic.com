...
$result=$staticpageObj->delete($pk);
if($result)
{
...
?>
	...
	<div id="kt_content_container" class="container-xxl">
                                ...
                                <div class="card card-flush border-gray-300 shadow-sm ">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-hover table-rounded table-row-bordered border gy-3 gs-3">
            ...
            <th>Action</th>
                                                ...
                                                <tbody>
                                                   <?php  
                                                   $result=$staticpageObj->selectAllDataForAdmin();
                                                   $sno=1;
            ...
            <td><?php echo $row['Modified'] ?></td>    
                                                    ...
                                                    <td>
                                                    <div class="row">
<form method="post" class="col-md-6 px-0" action="SEOAddEdit">
<?php  $newid= $crypt->encryptId($row['SPMetaID']); ?>
...
<input type="hidden" name="SPMetaID" class="form-control mb-2"
                                                value="<?php echo  $newid  ?>">
                                                       ...
                                                       <svg
                                                        ...
                                                        <form method="post" class="col-md-6 px-0" action="metahomepage.php">
                                                        <input type="hidden" name="SPMetaID" class="form-control mb-2"
                                                value="<?php echo  $newid  ?>">
