    ...
    <div class="card card-flush border-gray-300 shadow-sm ">
        <div class="card-header">
            <h3 class="card-title fw-bolder"><img src="assets/media/icons/duotune/text/txt009.svg" />&nbsp;
                Blog Details <!-- <div class="card-toolbar">
            ...
            <div class="card-toolbar"> <!-- Button trigger modal -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                    <a type="button" class="btn btn-sm btn-primary" href="BlogAddEdit">
                        ADD BLOG
                    </a>
                    </div>
                </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <thead class="bg-gray-200 ">
                    ...
                    <tbody>
                        <?php
                        $result = $blogObj->selectAllDataForAdmin();
                        $sno = 1;
            ...
            <td ><?php echo $row['Modified'] ?></td>
                                                    <td>
                                                    <div class="row">
                                        <form method="post" class="col-md-6 p-0" action="BlogAddEdit">
                                             <?php  $newid= $crypt->encryptId($row['BlogID']); ?>
                                        ...
                                        <form method="post" class="col-md-6 p-0" action="Blog">
                                            <input type="hidden" name="BlogID" 
                                                value="<?php echo $newid ?>">
