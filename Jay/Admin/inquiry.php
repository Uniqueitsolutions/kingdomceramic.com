...
if(isset($_POST['delete']))
{
    ...
    $pk = $crypt->decryptId($_POST['InquiryID']); 
$result=$inquiryObj->delete($pk);
if($result)
{
   
   echo "<script>window.location.href='Inquiry';</script>";
...
?>
    ...
    <?php  
                                                   $result1=$inquiryObj->selectAllDataForAdmin();
                                ...
                                <div class="card card-flush border-gray-300 shadow-sm ">
                                    <div class="card-header">
                                        ...
                                        Inquiry Details                                        <!-- <div class="card-toolbar">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table id="myTable" class="table table-bordered  table-hover table-rounded table-row-bordered border gy-3 gs-3">
                                                ...
                                                <tbody>
                                                   <?php  
                                                   $result=$inquiryObj->selectAllDataForAdmin();
                                                   $sno=1;
                                                   ...
                                                   ?>
                                                    ...
                                                    <td>
<div class="row">
<form method="post" class="col-md-6 px-0" action="Inquiry">
<?php  $newid= $crypt->encryptId($row['InquiryID']); ?>

                                                        <input type="hidden" name="InquiryID" class="form-control mb-2"
                                                value="<?php echo  $newid  ?>">
                                                            <button type="submit" name="change" style="background-color: transparent;border:0px"  >
                                                      <span class="svg-icon svg-icon-danger svg-icon-2hx"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check2" viewBox="0 0 16 16">
...
<br/>
                                <div class="card card-flush border-gray-300 shadow-sm ">
                                    <div class="card-header">
                                        <h3 class="card-title fw-bolder"><img src="assets/media/icons/duotune/text/txt009.svg" />&nbsp;
                                  Checked  Inquiry Details                                        <!-- <div class="card-toolbar">
                                            <a href="addprogram.html" class="btn btn-sm btn-primary">ADD Slider</a>
                                        </div> -->
                                        </h3>
                                        <div class="card-toolbar">                                      <!-- Button trigger modal -->
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table id="myTable" class="table table-bordered  table-hover table-rounded table-row-bordered border gy-3 gs-3">
                                                ...
                                                <tbody>
                                                   <?php  
                                                   $result=$inquiryObj->selectAllDataForAdminChanged();
                                                   $sno=1;
                                                   while($row=mysqli_fetch_assoc($result))             
                                                      {
