...
?>
	...
	<div id="kt_content_container" class="container-xxl">
                    ...
                    <div class="col-md-5">
                    <a type="button" class="btn btn-sm btn-primary" href="SizeAddEdit">
                        ADD SIZE
                    </a>
                    </div>
                </div>
                                ...
                                <td>
                                    <?php if ($row['IsActive'] == 1) {
                                        ...
                                        echo "<span class='badge badge-light-danger'>Disabled</span>";
                                                    ...
                                                    <td>
                                                    <div class="row">
                                        <form method="post" class="col-md-6 p-0" action="SizeAddEdit">
                                        <?php  $newid= $crypt->encryptId($row['SizeID']); ?>
                                        ...
                                        <form method="post" class="col-md-6 p-0" action="Size">
                                            <input type="hidden" name="SizeID" 
                                                value="<?php echo $newid ?>">
