...
if ($result) {
    ...
    <script>
        Swal.fire({
            icon: 'error',
            title: 'Error!',
            text: 'An error occurred while deleting the space.',
        });
    </script>";
}
...
?>
	...
	<div id="kt_content_container" class="container-xxl">
                    ...
                    <div class="col-md-5">
                    <a type="button" class="btn btn-sm btn-primary" href="SpaceAddEdit">
                        ADD SPACE
                    </a>
                    </div>
                </div>
                                ...
                                <td>
                                    <?php if ($row['IsActive'] == 1) {
                                        ...
                                        echo "<span class='badge badge-light-danger'>Disabled</span>";
                                                    ...
                                                    <td>
                                                    <div class="row">
                                        <form method="post" class="col-md-6 p-0" action="SpaceAddEdit">
                                        <?php $newid = $crypt->encryptId($row['SpaceID']); ?>
                                        ...
                                        <form method="post" class="col-md-6 p-0" action="Space">
                                            <input type="hidden" name="SpaceID" 
                                                value="<?php echo $newid ?>">
