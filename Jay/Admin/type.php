    ...
    <div class="card card-flush border-gray-300 shadow-sm ">
        <div class="card-header">
            ...
            <div class="row">
                    ...
                    <div class="col-md-5">
                    <a type="button" class="btn btn-sm btn-primary" href="TypeAddEdit">
                        ADD TYPE
                    </a>
                    </div>
                </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="myTable" class="table table-bordered table-hover table-rounded table-row-bordered  gy-3    gs-3">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <form method="post" class="col-md-6 p-0" action="TypeAddEdit">
                                        <?php $newid = $crypt->encryptId($row['TypeID']); ?>
                                        ...
                                        <form method="post" class="col-md-6 p-0" action="Type">
                                            <input type="hidden" name="TypeID" 
                                                value="<?php echo $newid ?>">
