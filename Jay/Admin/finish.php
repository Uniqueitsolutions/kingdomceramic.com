...
if ($result) {
    ...
    <script>
        Swal.fire({
            icon: 'error',
            title: 'Error!',
            text: 'An error occurred while deleting the finish.',
        });
    </script>";
}
...
?>
	...
	<div id="kt_content_container" class="container-xxl">
                    ...
                    <div class="col-md-5">
                    <a type="button" class="btn btn-sm btn-primary" href="FinishAddEdit">
                        ADD FINISH
                    </a>
                    </div>
                </div>
                            ...
                            <th>Action</th>
                                ...
                                <td>
                                    <div class="row">
                                        <form method="post" class="col-md-6 p-0" action="FinishAddEdit">
                                        <?php  $newid= $crypt->encryptId($row['FinishID']); ?>

                                            <input type="hidden" name="FinishID"
                                        ...
                                        <form method="post" class="col-md-6 p-0" action="Finish">
                                            <input type="hidden" name="FinishID" 
                                                value="<?php echo $newid ?>">
