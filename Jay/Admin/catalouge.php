    ...
    if ($result) {
        ...
        <script>
            Swal.fire({
                icon: 'success',
                title: 'Deleted!',
                text: 'The Catalouge has been deleted.',
            }).then(function() {
        ...
        <script>
            Swal.fire({
                icon: 'error',
                title: 'Error!',
                text: 'An error occurred while deleting the Catalouge.',
            });
        </script>";
    }
    ...
    <div class="card card-flush border-gray-300 shadow-sm ">
        <div class="card-header">
            <h3 class="card-title fw-bolder"><img src="assets/media/icons/duotune/text/txt009.svg" />&nbsp;
                Catalouge Details <!-- <div class="card-toolbar">
            ...
            <div class="card-toolbar"> <!-- Button trigger modal -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                    <a type="button" class="btn btn-sm btn-primary" href="CatalougeAddEdit">
                        ADD CATALOUGE
                    </a>
                    </div>
                </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <thead class="bg-gray-200 ">
                    ...
                    <tbody>
                        <?php
                        $result = $catalougeObj->selectAllDataForAdmin();
                        $sno = 1;
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                <td ><?php echo $sno++ ?></td>
                                <td>
                                    <?php echo $row['CatalougePriviewTitle'] ?>
                                </td>
                                <td>
                                    <?php echo $row['Sequence'] ?>
                                </td>
                                <td><img loading="lazy" src="../../Images/catalouge/<?php echo $row['ImagePath'] ?>"
                                        alt="<?php echo $row['ImageDescription'] ?>"
                                    
                                        style="width:200px ; height:150px; border-radius: 1%;"></td>
            ...
            <td ><?php echo $row['Modified'] ?></td>
                                                    <td>
                                                    <div class="row">
                                        <form method="post" class="col-md-6 p-0" action="CatalougeAddEdit">
                                        <?php  $newid= $crypt->encryptId($row['CatalougeID']); ?>

                                            <input type="hidden" name="CatalougeID"
                                        ...
                                        <form method="post" class="col-md-6 p-0" action="Catalouge">
                                            <input type="hidden" name="CatalougeID" 
                                                value="<?php echo $newid ?>">
