...
{    
$pk = $crypt->decryptId($_POST['ContactDetailsID']); 

$result=$contactObj->delete($pk);
if ($result) {
...
?>
	...
	<div id="kt_content_container" class="container-xxl">
                    ...
                    <div class="col-md-5">
                    <a type="button" class="btn btn-sm btn-primary" href="Contact">
                        ADD CONTACT
                    </a>
                    </div>
                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table id="myTable" class="table table-bordered table-rounded table-hover table-row-bordered border gy-4 gs-3">
            ...
            <th>Action</th>
                                                ...
                                                <tbody>
                                                   <?php  
                                                   $result=$contactObj->selectAllDataForAdmin();
                                                   $sno=1;
            ...
            <td>
                <table>
                <tr><?php echo $row['ContactNumber1'] ?></tr>
                <br/>
            <tr><?php echo $row['ContactNumber2'] ?></tr>
                                                      </table>
           
            </td>
            <td>
            <table>
            <tr><?php echo $row['Email1'] ?></tr>
            <br/>
            <tr><?php echo $row['Email2'] ?></tr>
                                                      </table>  
            </td>
            ...
            <td><?php echo $row['Modified'] ?></td>
                                                    <td>
                                                    <div class="row">
                                        <form method="post" class="col-md-6 p-0" action="ContactAddEdit">
                                        <?php  $newid= $crypt->encryptId($row['ContactDetailsID']); ?>

                                            <input type="hidden" name="ContactDetailsID"
                                        ...
                                        <form method="post" class="col-md-6 p-0" action="Contact">
                                            <input type="hidden" name="ContactDetailsID" 
                                                value="<?php echo $newid ?>">
